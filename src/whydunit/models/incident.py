...
class IncidentScenario:
    ...
    is injected first; ``secondary_signals`` are the knock-on effects the
    scenario also perturbs, in propagation order.
    """
...
class GroundTruth:
    ...
    from where symptoms are loudest); ``injected_signals`` lists every
    signal the scenario deliberately perturbed.
    """
